  ...
  <div class="header-tools__items">
    ...
    ?>
      <div class="header-tools__item header-tools__item--cta">
        <a
          href="<?php echo get_theme_mod( 'header_button_url' ); ?>"
          class="header-tools__button<?php if ($external_header_link) echo ' header-tools__button--external'; ?>" <?php if ($external_header_link) echo 'target="_blank"' ?>
          title="<?php _e( get_theme_mod( 'header_button_text' ), 'admin_texts_theme_mods_ea' ); ?>"
        >
          <?php _e( get_theme_mod( 'header_button_text' ), 'admin_texts_theme_mods_ea' ); ?>
          <?php if ($external_header_link) get_template_part( 'template-parts/icons/icon', 'external' ); ?>
        </a>
      </div>
    <?php endif; ?>
